...
int main()
{
    ...
    Matrix4x4 a = Matrix4x4( 1.f , 0.f , 0.f , 0.f,
                             0.f , 1.f , 0.f , 0.f,
                             0.f , 0.f , 1.f , 0.f,
                             0.f , 0.f , 0.f , 1.f );


    cout << a.determinate() << endl;

    Matrix4x4 inv = a.fastInverse();
    ...
    gl.setClearColor( Color<float,4>( 0.4f, 0.55f , 0.25f , 1.f ) );
    ...
    Vertex_Colored v;
    v.color = Limp::Color4f(0.65f,0.9f,0.3f,0.2f);
    ...
    v.color = Limp::Color4f(0.9f,0.5f,0.0f,0.2f);
